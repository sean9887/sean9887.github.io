...
vis.destroy_window()
```
<img src="https://github.com/user-attachments/assets/7109d807-d47b-4a98-b94f-64e9f81955a7" alt="lidar" width="50%"/>
...
def create_bbox_in_lidar(label, cam_to_velo):
    ...
    return bbox
```
<img src="https://github.com/user-attachments/assets/6d6f9246-4a7b-4ced-b53d-2b355eb2e422" alt="lidar_with_annotation" width="50%"/>